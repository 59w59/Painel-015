...
// Endpoint para verificar login no site da Riachuelo, protegido por JWT
app.post('/api/check-riachuelo', authenticateJWT, async (req, res) => {
    ...
    try {
        // Navegar até a página principal da Riachuelo
        await driver.get('https://www.riachuelo.com.br/');
        ...
        } else if (url === 'https://www.riachuelo.com.br/customer/account/loginSuccess') {
...
// Iniciar o servidor
app.listen(port, () => {
    console.log(`API da Riachuelo rodando em http://localhost:${port}`);
});
